SUBROUTINE ADJOINT1(LOOP, Ra, Pr, FIQ)
...
!--- Inner Iteration!
      DO ITER = 1, INLOOP
         ...
         CALL   SUBUA1(ERROU,OMIGU,ISTATE,NSCHEMEUV,Pr,Ra)

 	     CALL   SUBVA1(ERROV,OMIGV,ISTATE,NSCHEMEUV,Pr,Ra)

         CALL  SUBPCA1(ERROPC,OMIGPC)

         CALL   SUBTA1(ERROT,OMIGT,NSCHEMET,Pr,Ra,FIQ)
...
SUBROUTINE SUBUA1(ERROU,OMIGU,ISTATE,NSCHEMEUV,Pr,Ra)
...
SUBROUTINE SUBVA1(ERROV,OMIGV,ISTATE,NSCHEMEUV,Pr,Ra)
...
SUBROUTINE SUBTA1(ERROT,OMIGT,NSCHEMET,Pr,Ra,FIQ)
