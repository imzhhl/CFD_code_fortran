...
!
   ...
   OPEN(500,FILE='RecordAlpha.dat',STATUS='UNKNOWN')
...
! ! BELOWS ARE THE COEFFICIENTS NEEDED FOR THE CALCULATION OF THE STEP SIZE
		...
		ALPHA1W = (V1*V2-V3*V4)/(V5*V2-V3**2)
		ALPHA2W = (V4*V5-V3*V1)/(V5*V2-V3**2)
		WRITE(*, 128) ALPHA1FZ,ALPHA1FM, ALPHA2FZ, ALPHA1W, ALPHA2W
128 FORMAT(5(E15.6E3,2X))
        
		DO J = 2 , NJM
	       WRITE(500,501) CSD1(KCG,J),CSD2(KCG,J)
501 FORMAT(2(E15.6E3,2X))		
        ENDDO
		
		WRITE(500, 502) ALPHA1FZ,ALPHA1FM, ALPHA2FZ 
502 FORMAT(3(E15.6E3,2X))

        WRITE(500, 503) ALPHA1W, ALPHA2W, ALFA1, ALFA2
503 FORMAT(4(E15.6E3,2X))

        DO J = 2 , NJM
	       WRITE(500,504) ALFA1*CSD1(KCG,J), ALFA2*CSD2(KCG,J), ALPHA1W*CSD1(KCG,J), ALPHA1W*CSD2(KCG,J)
504 FORMAT(4(E15.6E3,2X))		
        ENDDO
